            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  ...
                  {store.twitterUrl && (
                    <a href={store.twitterUrl} target="_blank" rel="noreferrer" className="text-surface-400 hover:text-surface-950 transition-colors">
        ...
        <footer className="bg-white border-t border-surface-200 mt-12 py-8">
          <div className="max-w-5xl mx-auto px-4 text-center space-y-4">
            ...
            <div className="flex justify-center items-center gap-4 mt-6">
              {store.facebookUrl && <a href={store.facebookUrl} target="_blank" rel="noreferrer" className="w-10 h-10 bg-surface-100 flex items-center justify-center hover:bg-surface-200 transition-colors text-surface-700"><FacebookIcon className="w-5 h-5" /></a>}
              {store.instagramUrl && <a href={store.instagramUrl} target="_blank" rel="noreferrer" className="w-10 h-10 bg-surface-100 flex items-center justify-center hover:bg-surface-200 transition-colors text-surface-700"><InstagramIcon className="w-5 h-5" /></a>}
              {store.twitterUrl && <a href={store.twitterUrl} target="_blank" rel="noreferrer" className="w-10 h-10 bg-surface-100 flex items-center justify-center hover:bg-surface-200 transition-colors text-surface-700"><XIcon className="w-5 h-5" /></a>}
